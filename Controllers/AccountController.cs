    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> RegisterAsync (RegisterViewModel model)  
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded) 
                {
                    ...
                    ViewBag.ErrorTitle = "Regstration Succeful";
                    ViewBag.ErrorMessage = "Before you can login , please confirm your email by clicking "+
                                            "confirmation link that was emailed to you";
                    return View("Error");
                }
        ...
        public async Task<IActionResult> ExternalLoginCallbackAsync(string returnUrl = null , string remoteError = null)
        {
            ...
            else
            {
                ...
                ViewBag.ErrorMessage = $"Please contact the support team";
        ...
        [HttpPost]
        public async Task<IActionResult> ChangePassowrdAsync(ChangePasswordViewModel model)
        {
            if (ModelState.IsValid) 
            {
                var user = await userManager.GetUserAsync(User);
